...
const AssertRecoble = () => {
  return (
    <div className="w-full max-h-screen bg-black p-8 flex flex-row justify-center items-center">
      <div className="bg-gray-100 w-full h-full rounded-2xl sm:pr-0 lg:pt-12 lg:py-12 flex flex-wrap md:flex-nowrap justify-between gap-0 lg:gap-6">
        <div className="w-full lg:w-1/2 flex flex-col gap-8 justify-center items-center pt-8 md:pt-0">
        ...
        <div className="pl-8 pt-6 lg:pt-0 md:pl-0 w-full lg:w-1/2 flex justify-end">
          <Image
            height={490}
